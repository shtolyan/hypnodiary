...
### 3. Создать SQLite базу

```bash
node db_init.js
```

Это создаст файл `sessions.db` с нужной таблицей.
...
На данный момент проект **не требует аутентификации**. Все данные хранятся локально в `sessions.db`.  
